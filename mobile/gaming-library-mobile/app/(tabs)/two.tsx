...
export default function GamesScreen() {
  ...
  const games = [
    ...
    },
    {
      id: '5',
      title: 'Elden Ring',
      coverImage: 'https://via.placeholder.com/150x200/f97316/ffffff?text=ER',
      platform: 'PC',
      status: 'playing',
      playtime: 80,
    ...
    },
    {
      id: '6',
      title: 'God of War',
      coverImage: 'https://via.placeholder.com/150x200/be185d/ffffff?text=GOW',
      platform: 'PlayStation',
      status: 'completed',
      playtime: 35,
      totalAchievements: 70,
      unlockedAchievements: 70,
    },
  ];
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <Text style={[styles.title, { color: colors.text }]}>All Games</Text>
      <FlatList
        data={games}
